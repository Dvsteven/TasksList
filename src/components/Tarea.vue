                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button v-on:click="agregarTarea"
                                    class="btn btn-success btn-lg">Agregar Tarea</button>
                            </div>
                        </div>
                        <br>
                        <h5 v-if="listTareas.length == 0">No hay tareas por realizar</h5>
                        <ul clasS="list-group">
                            <li v-for="(tarea, index) of listTareas" :key="index"
                                ...
                                {{ tarea.nombre }}
                                <span class="tetx-danger cursor" v-on:click="eliminarTarea()">
...
<!-- Tuve que editar el nombre para hacerlo compuesto. -Sugerencia Herramienta web -->
<script>
    export default {
       name: 'TareaItem',
       data () {
